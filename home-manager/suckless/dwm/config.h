...
static const char *brightnessup[] = {"/home/blazzee/.config/scripts/brightness.sh", "inc", NULL};
...
static const char *bt_ui[] = { "/bin/sh", "-c", "/home/blazzee/.config/scripts/bluetooth.sh", NULL };
...
void view_adjacent(const Arg *arg){
 ...
 for (i = 0; i < LENGTH(tags); i++) {
    ...
    int newtag = (curtag + arg->i) % LENGTH(tags);
    if (newtag < 0)
        newtag += LENGTH(tags);
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_v,      spawn,          {.v = min} },
	{ MODKEY,                       XK_r,      spawn,          {.v = zellij_resurrect} },
	{ MODKEY,                       XK_w,      spawn,          {.v = nm_ui} },
	{ MODKEY,                       XK_q,      spawn,          {.v = bt_ui} },
